...
public:
	...
	zc_calendar_table(int X, int Y, int W, int H, tm date);

	//! Destructor.
	virtual ~zc_calendar_table();

	//! \brief Overload of Fl_Table::draw_cell is called to draw the contents of the cell.
	...
	//! \return Date as a pointer to a tm structure.
