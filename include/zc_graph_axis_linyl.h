...
//! \brief Class to represent a linear Y axis on a graph, including scaling and zooming options.
//! 
class zc_graph_axis_linyl : public zc_graph_axis_linear {

public:

	//! \brief Constructor
	zc_graph_axis_linyl(int X, int Y, int W, int H, const char* L = nullptr);
