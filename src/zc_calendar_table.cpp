...
zc_calendar_table::zc_calendar_table(int X, int Y, int W, int H, tm date) :
...
// Destructor
zc_calendar_table::~zc_calendar_table()
{
}

// inherited from Fl_Table_Row - called when a cell is being drawn
void zc_calendar_table::draw_cell(TableContext context, int R, int C, int X, int Y,
	int W, int H) {
...
tm& zc_calendar_table::value() {
	return selected_date_;
}

// Set the value
void zc_calendar_table::value(tm date) {
...
tm* zc_calendar_table::get_date(int R, int C) {
