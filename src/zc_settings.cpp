...
json* zc_settings::all_settings_ = nullptr;
int zc_settings::attachments_ = 0;
...
zc_settings::zc_settings(zc_settings* parent, const std::string name) {
	parent_ = parent;
	name_ = name;
